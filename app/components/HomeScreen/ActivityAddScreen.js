...
import {deepCopy, durationUnit} from "../functions/helpFunctions";
import {connect} from "react-redux";
import {addActivity, saveActivity, uploadImage} from '../../actions/creators';
import {RichTextEditor, RichTextToolbar} from '../CommonComponent/react-native-zss-rich-text-editor';
import actionTools from '../../assets/editorTools';
...
const mapStateToProps = state => {
  ...
  tmp['chiefClubs'] = deepCopy(state.myClubList.chiefClubs);
  // console.log(tmp);
  return tmp;
