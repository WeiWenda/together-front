...
export default class RichTextEditor extends Component {
    ...
    try {
      ...
      switch (message.type) {
        ...
        case messages.CONTENT_CHANGE: {
          const {content,height} = message.data;
          this.state.onChange.map((listener) => listener(content,height));
          break;
        }
  ...
  render() {
    //in release build, external html files in Android can't be required, so they must be placed in the lib folder and accessed via uri
