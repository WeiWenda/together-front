 ...
 */
const BackendFactory = require('../../lib/loginConf/BackendFactory').default

import {appAuthToken} from '../../lib/loginConf/AppAuthToken'
 ...
 */
export function getSessionToken (navigation) {
  return dispatch => {
